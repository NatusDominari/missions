...
if (!isDedicated) then {
    ...
    _quote = composeText [
        parseText "<t size='1' align='left' shadow='1'>Let your plans be dark and impenetrable as night, and when you move, fall like a thunderbolt.</t>",
        lineBreak,
        parseText "<t size='0.8' align='left' color='#717171'>SUN TZU, ART OF WAR</t>"
    ];
    ...
    _quote = composeText [
        ...
        lineBreak,
        parseText "<t size='1.2' align='center' shadow='2'>AN UNKNOWN ENEMY</t>"
    ];
